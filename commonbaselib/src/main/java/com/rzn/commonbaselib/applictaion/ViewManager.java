...
public class ViewManager {
    ...
    private static List<MVPBaseFragment> fragmentList;
    ...
    public void addFragment(int index, MVPBaseFragment fragment) {
    ...
    public MVPBaseFragment getFragment(int index) {
        if (fragmentList != null) {
    ...
    public List<MVPBaseFragment> getAllFragment() {
        if (fragmentList != null) {
            return fragmentList;
        }
        return null;
