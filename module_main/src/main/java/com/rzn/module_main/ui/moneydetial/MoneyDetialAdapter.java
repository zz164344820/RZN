...
public class MoneyDetialAdapter extends BaseQuickAdapter<AccountWaterListBean, BaseViewHolder> {
    public MoneyDetialAdapter(int layoutResId, @Nullable List<AccountWaterListBean> data) {
...
//        private String userName;//": "支付测试" //用户姓名
        ...
        helper.setText(R.id.tv_title, item.getTaskTypes());
