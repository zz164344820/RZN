...
public class FarmTaskInfo {
   ...
   private   String    address;//河北省石家庄天上马街1处",//家庭地址
    ...
    private  String       startDate;//作业开始日期
    private  String       status;//订单状态 1: 待接单  2:  待作业  3:已取消  4:已完成
