package com.zyhealth.expertlib.utils;
...
public class GlideUtils {
     ...
     */
    /*加载圆角*/
    public   static   void loadImageRound(Context mContext ,String path, ImageView mImageView ,int v){
        Glide.with(mContext).load(path).transform(new GlideRoundTransform(mContext,v)).into(mImageView);
    }

    /*加载圆角 ,占位图*/
    public   static   void loadImageRound(Context mContext ,String path, ImageView mImageView ,int errorImageView,int v){
        Glide.with(mContext).load(path).placeholder(errorImageView).transform(new GlideRoundTransform(mContext,v)).into(mImageView);
    }
