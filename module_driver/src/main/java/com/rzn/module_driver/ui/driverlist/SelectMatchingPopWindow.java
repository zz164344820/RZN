...
public class SelectMatchingPopWindow extends PopupWindow{
	private  Context mContent;
	OnClickListener clickListener;
	View view;


	public SelectMatchingPopWindow(Context context, OnClickListener clickListener) {
		super(context);
		 this.mContent = context;
		this.clickListener =clickListener;
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		view = inflater.inflate(R.layout.driver_pop_bottom, null);
		listener();
